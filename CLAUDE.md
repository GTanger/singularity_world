...
## 世界觀（簡化版，2026-04-25 大刀）

> **這是一個能量充沛的奇幻世界**。能量無處不在、可採可用。沒有現代地球前史、沒有降維/降臨、沒有神化人/母腦/異化人、沒有 USD 紀。形上學解釋全冷凍至 `docs/archived/現代地球設定/`。

**保留的純機制**（不掛形上學包裝）：
- **能量密度**：人多的地方能量稀薄、人少的地方豐沛（density_multiplier ×3 / ×1 / ×0.6 / ×0.3）
- **聚念場效應**：城鎮資源刷新慢、野外刷新快。公會壟斷物理上不可能
- **詞元**：能量凝結成的字。殺生物可剝名取得；整剝難品質高、肢解後分剝容易
- **富態化**：能量過剩讓萬物瘋長（純現象，不解釋為什麼）
- **同頻相斥**：玩家詞盤越專精 → 同類字效更強，但其他類削弱
- **止念**：玩家壓制頻率以採集能量微波（修煉動作）
- **修煉體系**：竅穴、念紋（不掛 Token 形上學，視為奇幻世界的修煉設定）
- **貨幣**：鎂

**冷凍**（封存於 archived 不再用）：神化人/神化體/母腦、異化人、降臨/煙火日/解放日/T 彈、降維失敗、創造者念場、現代地球紀年、電子與精密機械附篇
