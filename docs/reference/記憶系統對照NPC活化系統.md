...
| **第五階段「NPC 之間互動」** | 觸發（閒置／排班／隨機）、AI 一來一往、主題劇本、NpcNpcSummaries | ✅ | 見 [003](discussions/003_NPC交互對話系統.md) §十 實作確認清單；main.go `tryTriggerNpcNpcInRoom`、ai/talk.go `CallAITalkNPCToNPC` |
